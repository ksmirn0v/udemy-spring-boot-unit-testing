...
public class StudentAndGradeServiceTest {
    ...
    public void isStudentNullCheck() {
        ...
        assertTrue(studentService.isStudentPresent(1), "@BeforeTransaction creates student : return true");

        assertFalse(studentService.isStudentPresent(0), "No student should have 0 id : return false");
    }
    ...
    @Test
    public void getStudentFullInformationService() {
        GradebookCollegeStudent gradebookCollegeStudentTest = studentService.getStudentFullInformation(1);
    ...
    public void isGradeNullCheck() {
        ...
        assertTrue(studentService.isGradePresent(1, "math"),
                "@BeforeTransaction creates student : return true");

        assertTrue(studentService.isGradePresent(1, "science"),
                "@BeforeTransaction creates student : return true");

        assertTrue(studentService.isGradePresent(1, "history"),
                "@BeforeTransaction creates student : return true");

        assertFalse(studentService.isGradePresent(0, "science"),
                "No student should have 0 id : return false");

        assertFalse(studentService.isGradePresent(0, "Literature"),
                "No student should have 0 id : return false");
    }
